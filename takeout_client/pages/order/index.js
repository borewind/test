...
export default {
	data() {
		return {
			...
			address: '',//地址
			remark: '',//备注
			arrivalTime: '18:40',// 用户选择的送达时间
			orderTime: '18:35',// 服务端返回的送达时间
			addressBookId: '',
			addressLabel: '',
			tagLabel: '',
			// 加入购物车数量
			...
			popright: ['09:00', '09:30', '10:00', '10:30', '11:00', '11:30', '12:00', '12:30', '13:00',
	...
	methods: {
		...
		payOrderHandle() {
			...
			const params = {
				...
				remark: this.remark,
				estimatedDeliveryTime: presentFormat(),
